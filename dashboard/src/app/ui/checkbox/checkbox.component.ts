...
/**
 * A square checkbox: 2 px ink rule, the fill scales in from 0.6 over 150 ms.
 *
...
@Component({
  ...
  template: `
    <label class="check" [class.is-disabled]="disabled()">
      ...
      />
      <span class="check__box" aria-hidden="true"><span class="check__fill"></span></span>
  ...
  styles: `
    ...
    .check__native:checked + .check__box .check__fill {
      transform: scale(1);
    }
