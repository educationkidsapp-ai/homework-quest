...
@Serializable data class LessonFilter(val curriculum: Curriculum? = null, val grade: Int? = null, val subject: Subject? = null, val from: LocalDate? = null, val to: LocalDate? = null, val status: LessonStatus? = null)
@Serializable data class CreateLessonRequest(val curriculum: Curriculum, val grade: Int, val subject: Subject, val date: LocalDate, val notes: String? = null, val practiceLength: Int = 7)
...
data class AdminLesson(
    ...
    val publishedAt: Long? = null, val createdAt: Long = 0,
)
