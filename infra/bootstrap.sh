...
#
#   export DEEPSEEK_API_KEY=sk-... ADMIN_PASSWORD=...          # never committed; FIREBASE_CREDENTIALS / ANTHROPIC_API_KEY / RESEND_API_KEY / SEED_STAFF_PASSWORD optional
...
[ -n "${SEED_STAFF_PASSWORD:-}" ] && gh secret set SEED_STAFF_PASSWORD --env "$GH_ENV" --repo "$REPO" --body "$SEED_STAFF_PASSWORD"   # shared password of the seeded teachers (optional)
